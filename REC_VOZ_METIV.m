...
y=audiorecorder(tiempograb*fs,fs,1); %función de grabacion
...
audioread(yf,fs,'voz'); %Graba en archivo .wav
...
function BotonReproducir_Callback(~, ~, ~)
...
function BotonTransformar_Callback(hObject, ~, handles)
y=handles.y;
fs=11025;
